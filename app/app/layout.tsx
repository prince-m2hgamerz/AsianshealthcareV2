...
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || DEFAULT_SETTINGS.site_url;

export const metadata: Metadata = {
  metadataBase: new URL(siteUrl),
  title: {
    default: `${DEFAULT_SETTINGS.site_name} - ${DEFAULT_SETTINGS.meta_tagline}`,
  ...
  icons: {
    icon: DEFAULT_SETTINGS.favicon_icon || "/newlogo/logo-mark.png",
    shortcut: DEFAULT_SETTINGS.favicon_icon || "/newlogo/logo-mark.png",
    apple: DEFAULT_SETTINGS.favicon_apple || DEFAULT_SETTINGS.favicon_icon || "/newlogo/logo-mark.png",
  },
  openGraph: {
    title: `${DEFAULT_SETTINGS.site_name} - ${DEFAULT_SETTINGS.meta_tagline}`,
    description: DEFAULT_SETTINGS.meta_description,
