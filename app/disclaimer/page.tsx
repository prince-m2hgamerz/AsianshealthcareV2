      ...
      <section className="bg-surface py-huge">
        <div className="container-cinematic">
          <div className="max-w-reading-col mx-auto text-body-lg text-shade-50 leading-relaxed space-y-6">
            <h2 className="font-display text-heading-xl text-text">No Medical Advice</h2>
            ...
            <h2 className="font-display text-heading-xl text-text">Accuracy</h2>
            ...
            <h2 className="font-display text-heading-xl text-text">External Links</h2>
