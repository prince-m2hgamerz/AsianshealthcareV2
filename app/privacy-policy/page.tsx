      ...
      <section className="bg-surface py-huge">
        <div className="container-cinematic">
          <div className="max-w-reading-col mx-auto text-body-lg text-shade-50 leading-relaxed space-y-6">
            <h2 className="font-display text-heading-xl text-text">Information We Collect</h2>
            ...
            <h2 className="font-display text-heading-xl text-text">How We Use Your Data</h2>
            ...
            <h2 className="font-display text-heading-xl text-text">Data Security</h2>
            ...
            <h2 className="font-display text-heading-xl text-text">Your Rights</h2>
            ...
            <h2 className="font-display text-heading-xl text-text">Cookies</h2>
            ...
            <h2 className="font-display text-heading-xl text-text">Third-Party Services</h2>
            ...
            <h2 className="font-display text-heading-xl text-text">Contact</h2>
