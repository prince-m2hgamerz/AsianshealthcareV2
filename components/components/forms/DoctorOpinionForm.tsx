...
export default function DoctorOpinionForm({ onClose }: DoctorOpinionFormProps) {
    ...
    return (
      <div className="text-center py-8">
        <div className="w-16 h-16 rounded-full bg-accent/10 flex items-center justify-center mx-auto mb-4">
          <Stethoscope size={28} className="text-text" />
        </div>
        <h3 className="font-display text-heading-md text-text mb-2">Request Submitted!</h3>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <h3 className="font-display text-heading-md text-text mb-2">Receive Doctor Opinion</h3>
      ...
      <textarea
        ...
        className="w-full border border-hairline-light rounded-md px-3 py-2.5 text-body-md text-text placeholder:text-shade-40 focus:outline-none focus:border-text transition-colors resize-none"
      />
